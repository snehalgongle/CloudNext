...
public class HalfCustomDivider extends RecyclerView.ItemDecoration {
    ...
    public HalfCustomDivider(int dividerHeight, int color) {
        mDividerHeight = dividerHeight;
        mColor = color;
        mOffsets = mDividerHeight;
    }

    public HalfCustomDivider() {
        super();
        mDividerHeight = 1;
        mColor = 0x8a000000;
    }

    public HalfCustomDivider(int dividerHeight, int color, int offsets, boolean adjustOffsets) {
        super();
